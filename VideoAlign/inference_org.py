...
if __name__ == "__main__":
    ...
    video_paths = [
        "/home/jjm/ex/Generation/cvpr2026/MMDisCo/VideoAlign/datasets/train/videos/example_1_A.mp4",
        "/home/jjm/ex/Generation/cvpr2026/MMDisCo/VideoAlign/datasets/train/videos/example_1_B.mp4",
        "/home/jjm/ex/Generation/cvpr2026/MMDisCo/VideoAlign/datasets/train/videos/example_2_A.mp4",
    ]
    ...
    csv_path = "/home/jjm/ex/Generation/cvpr2026/MMDisCo/data/metadata/test_header_mini_no_dup.csv"

    # Read the CSV file
    df = pd.read_csv(csv_path)

    # Extract the 'data' and 'text' columns into separate lists
    data = df['data'].tolist()
    text = df['text'].tolist()
